(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[7],{"97gy":function(e,r,t){"use strict"
...
_.variant="Solid"
_.propTypes=Object(a["a"])({},l["a"].propTypes)},HVsT:function(e,r,t){"use strict"
t.d(r,"a",(function(){return _}))
var a=t("VTBJ")
var n=t("1OyB")
var o=t("vuIU")
...
_.glyphName="no"
_.variant="Solid"
_.propTypes=Object(a["a"])({},l["a"].propTypes)},"L+/K":function(e,r,t){"use strict"
...
var I=function(e){Object(i["a"])(t,e)
var r=Object(s["a"])(t)
function t(){Object(n["a"])(this,t)
return r.apply(this,arguments)}Object(o["a"])(t,[{key:"render",value:function(){return c.a.createElement(B["a"],Object.assign({},this.props,{name:"IconInfoBorderless",viewBox:"0 0 1920 1920"}),j)}}])
...
var A=t("J2CL")
var S=t("BTe1")
function D(e){var r=e.colors,t=e.borders,a=e.spacing,n=e.typography,o=e.shadows
return{background:r.backgroundLightest,color:r.textDarkest,marginTop:a.small,borderRadius:t.radiusMedium,borderWidth:t.widthMedium,borderStyle:t.style,contentPadding:"".concat(a.small," ").concat(a.medium),contentFontSize:n.fontSizeMedium,contentFontFamily:n.fontFamily,contentFontWeight:n.fontWeightNormal,contentLineHeight:n.lineHeightCondensed,closeButtonMarginTop:a.xSmall,closeButtonMarginRight:a.xxSmall,iconColor:r.textLightest,successBorderColor:r.borderSuccess,successIconBackground:r.backgroundSuccess,infoBorderColor:r.borderInfo,infoIconBackground:r.backgroundInfo,warningBorderColor:r.borderWarning,warningIconBackground:r.backgroundWarning,dangerBorderColor:r.borderDanger,dangerIconBackground:r.backgroundDanger,boxShadow:o.depth2}}D.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}
var x,R,z,N,T
...
var U=(x=Object(g["a"])("8.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),R=Object(A["l"])(D,E),x(z=R(z=(T=N=function(e){Object(i["a"])(t,e)
var r=Object(s["a"])(t)
function t(e){var a
Object(n["a"])(this,t)
a=r.call(this,e)
...
a.handleKeyUp=function(e){(a.props.renderCloseButtonLabel||a.props.closeButtonLabel)&&e.keyCode===b.a.codes.esc&&a.close()}
a.state={open:true}
return a}Object(o["a"])(t,[{key:"variantUI",value:function(){return{error:{Icon:w["a"],className:E.error},info:{Icon:I,className:E.info},success:{Icon:M["a"],className:E.success},warning:{Icon:q["a"],className:E.warning}}[this.props.variant]}},{key:"clearTimeouts",value:function(){this._timeouts.forEach((function(e){return clearTimeout(e)}))
...
r&&u.a.render(null,r,(function(){var t=e.createScreenreaderContentNode()
u.a.render(t,r)}))}}},{key:"removeScreenreaderAlert",value:function(){var e=this.getLiveRegion()
...
var r=this.variantUI(),t=r.className
var n=m()((e={},Object(a["a"])(e,E.alert,true),Object(a["a"])(e,t,true),Object(a["a"])(e,E.hasShadow,this.props.hasShadow),e))
...
t.displayName="Alert"
return t}(d["Component"]),N.propTypes={children:v.a.node,variant:v.a.oneOf(["info","success","warning","error"]),margin:A["c"].spacing,liveRegion:v.a.func,liveRegionPoliteness:v.a.oneOf(["polite","assertive"]),isLiveRegionAtomic:v.a.bool,screenReaderOnly:v.a.bool,timeout:v.a.number,renderCloseButtonLabel:v.a.oneOfType([v.a.func,v.a.node]),closeButtonLabel:v.a.string,onDismiss:v.a.func,transition:v.a.oneOf(["none","fade"]),open:v.a.bool,hasShadow:v.a.bool},N.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",isLiveRegionAtomic:false,onDismiss:void 0,liveRegion:void 0,renderCloseButtonLabel:void 0,closeButtonLabel:void 0,children:null,hasShadow:true},T))||z)||z)},uloQ:function(e,r,t){"use strict"
...
return Object(a["a"])(v["a"],{as:"p",fontStyle:"italic"},void 0,Object(a["a"])(v["a"],{},void 0,r),t?b||(b=Object(a["a"])("br",{})):null,t?Object(a["a"])(v["a"],{},void 0,t):null)}render(){let e=null
this.props.error&&(e=this.state.showDetails?this.renderDetailMessage():Object(a["a"])("span",{},void 0,Object(a["a"])(p["a"],{},void 0,Object(a["a"])(_["a"],{variant:"link",onClick:this.showDetails},void 0,l.t("Details"))),Object(a["a"])(m["a"],{},void 0,this.renderDetailMessage())))
return Object(a["a"])(h["a"],{transitionOnMount:true,in:this.state.isOpen,type:"fade"},void 0,Object(a["a"])(u["a"],{variant:this.props.variant,renderCloseButtonLabel:l.t("Close"),onDismiss:this.closeAlert,margin:"small auto",timeout:this.props.timeout,liveRegion:this.getLiveRegion,transition:"fade",screenReaderOnly:this.props.screenReaderOnly},void 0,Object(a["a"])("div",{},void 0,Object(a["a"])("p",{style:{margin:"0 -5px"}},void 0,this.props.message),e)))}}y.defaultProps={error:null,variant:"info",timeout:f,screenReaderOnly:false}
function C({message:e,err:r,type:t=(r?"error":"info"),srOnly:n=false}){function o(e){s.a.unmountComponentAtNode(e)
...
document.body.appendChild(e)}return e}function d(i){s.a.render(Object(a["a"])(y,{message:e,timeout:Number.isNaN(parseInt(ENV.flashAlertTimeout,10))?f:ENV.flashAlertTimeout,error:r,variant:t,onClose:o.bind(null,i),screenReaderOnly:n}),i)}const c=document.createElement("div")
c.setAttribute("style","max-width:50em;margin:1rem auto;")
c.setAttribute("class","flashalert-message")
i().appendChild(c)
d(c)}function w(e=l.t("An error occurred making a network request")){return r=>C({message:e,err:r,type:"error"})}function O(e){return()=>C({message:e,type:"success"})}},znKQ:function(e,r,t){"use strict"
t.d(r,"a",(function(){return _}))
var a=t("VTBJ")
var n=t("1OyB")
var o=t("vuIU")
...
var r=Object(s["a"])(t)
function t(){Object(n["a"])(this,t)
return r.apply(this,arguments)}Object(o["a"])(t,[{key:"render",value:function(){return c.a.createElement(l["a"],Object.assign({},this.props,{name:"IconWarningBorderless",viewBox:"0 0 1920 1920"}),u)}}])
t.displayName="IconWarningBorderlessSolid"
return t}(d["Component"])
_.glyphName="warning-borderless"
_.variant="Solid"
_.propTypes=Object(a["a"])({},l["a"].propTypes)}}])

//# sourceMappingURL=7-c-5d565a537f.js.map