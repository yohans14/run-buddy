(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[45],{"+6XX":function(e,t,o){var c=o("y1pI")
...
var B=o("kC3k")
var I=o("JGuX")
const S={ADMIN_LOCKED:{label:w.t("Locked"),icon:q["a"],tooltip:w.t("Unlock"),variant:"primary"},ADMIN_UNLOCKED:{label:w.t("Blueprint"),icon:B["a"],tooltip:w.t("Lock"),variant:"default"},ADMIN_WILLUNLOCK:{label:w.t("Blueprint"),icon:B["a"],tooltip:w.t("Unlock"),variant:"default"},ADMIN_WILLLOCK:{label:w.t("Locked"),icon:q["a"],tooltip:w.t("Lock"),variant:"primary"},TEACH_LOCKED:{label:w.t("Locked"),icon:q["a"]},TEACH_UNLOCKED:{label:w.t("Blueprint"),icon:B["a"]}}
...
e.isToggleable?this.state.mode=e.isLocked?S.ADMIN_LOCKED:S.ADMIN_UNLOCKED:this.state.mode=e.isLocked?S.TEACH_LOCKED:S.TEACH_UNLOCKED}componentDidMount(){const e=Math.max(...Object.values(S).map(e=>e.label.length))
...
i=Object(c["a"])(C["a"],{tip:s,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,this.props.breakpoints.miniTablet?Object(c["a"])(O["a"],{id:"lock-toggle-btn",elementRef:e=>this.toggleBtnRef=e,variant:l,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,e||(e=Object(c["a"])(r,{})),t||(t=Object(c["a"])(x["a"],{},void 0,n)),o||(o=Object(c["a"])(E["a"],{},void 0,_))):Object(c["a"])(j["a"],{color:"primary"===l?l:null,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked,screenReaderLabel:_},void 0,a||(a=Object(c["a"])(r,{}))))}else i=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(r,{})),Object(c["a"])(m["a"],{size:"small"},void 0,n))
...
n[t]=o}))
r(n)
return{remove:function(){n&&Object.keys(n).forEach((function(e){n[e].removeListener(i)}))}}}var E={validQuery:function(e,t,o){try{j(e[t])}catch(e){return new Error("Invalid query prop supplied to `".concat(o,"`. ").concat(e.message))}}}
var q=function(e){Object(r["a"])(o,e)
var t=Object(n["a"])(o)
function o(){var e
Object(c["a"])(this,o)
...
q.propTypes={match:_.a.oneOf(["element","media"]),query:_.a.objectOf(E.validQuery).isRequired,props:_.a.objectOf(_.a.object),render:_.a.func,children:_.a.func}
q.defaultProps={children:null,render:void 0,match:"element",props:null}},"9Nap":function(e,t,o){var c=o("/9aa")
var a=1/0
...
//# sourceMappingURL=45-c-34da6eab5f.js.map