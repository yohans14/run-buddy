...
const s="bad_request"
const _=({targetWindow:e,origin:o,subject:c,message_id:t})=>{const _=(r={})=>{const n={subject:c+".response"}
t&&(n.message_id=t)
...
const k=()=>{d(a)}
const b=()=>{d(n)}
return{sendResponse:_,sendSuccess:i,sendError:d,sendGenericError:u,sendBadRequestError:p,sendWrongOriginError:k,sendUnsupportedSubjectError:b}}
var i=_
const d={}
...
//# sourceMappingURL=60-c-74aea52431.js.map